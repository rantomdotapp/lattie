...
import { TerminalCommand } from './cmd/terminal';
...
(async function () {
  ...
  const terminalCmd = new TerminalCommand();
  ...
  yargs(process.argv.slice(2))
    ...
    .command(terminalCmd.name, terminalCmd.describe, terminalCmd.setOptions, terminalCmd.execute)
